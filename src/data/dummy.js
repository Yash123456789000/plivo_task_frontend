...
export const rangeColorMapping = [
  { label: "1K to 10K", start: "1", end: "10", colors: colorMappingData[1] },

  { label: "11K to 20K", start: "11", end: "20", colors: colorMappingData[2] },

  { label: "21K to 30K", start: "21", end: "30", colors: colorMappingData[3] },
];
...
export const ordersGrid = [
  ...
  { field: "owner", headerText: "Owner", width: "150", textAlign: "Center" },
  {
    field: "lastUpdated",
    headerText: "Last Updated",
    format: "C2",
...
if (user?.role == "user") {
  userLineChartData = Array.isArray(user.lineChartData)
    ? user?.lineChartData[0]
    : [];
  userPieChartData = Array.isArray(user.pieChartData)
    ? user?.pieChartData[0]
    : [];
}
...
export const pieChartData =
  user?.role === "admin" ? adminPieChartData : userPieChartData;
