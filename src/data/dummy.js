...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiFillApi } from 'react-icons/ai';
...
export const links = user?.role === 'admin' ? adminLinks : userLinks;
...
export const ordersData = [
  ...
  },
  {
    ...
    Status: 'rejected',
    StatusBg: 'red',
    ProductImage: 'https://images.unsplash.com/photo.jpg'
  },
  {
    traffic: '19K',
    owner: 'Diana',
  ...
  },
  {
    ...
    company: 'Fresh Tomato',
    Location: 'Germany',
    Status: 'active',
    StatusBg: '#03C9D7',
    ProductImage: 'https://cdn.shopclues.com/image.jpg'
  },
  {
    traffic: '40K',
    owner: 'Ethan',
...
export const scheduleData = [
  {
    Id: 1,
    Subject: 'Weather API Integration',
    Location: 'Germany',
  ...
  {
    Id: 4,
    Subject: 'SQL Server Optimization',
    Location: 'France',
  ...
  {
    Id: 8,
    Subject: 'Node.js Express Routing',
    Location: 'Australia',
  ...
  {
    Id: 9,
    Subject: 'Django Admin Customization',
    Location: 'Mexico',
  ...
  {
    Id: 12,
    Subject: 'API Gateway Management',
    Location: 'Sweden',
  ...
  {
    Id: 14,
    Subject: 'Firebase Realtime Database',
    Location: 'USA',
  ...
  {
    Id: 15,
    Subject: 'API Rate Limiting Techniques',
...
let userLineChartData = []
let userPieChartData = []
if(user?.role=='user'){
  userLineChartData = Array.isArray(user.lineChartData) ? user?.lineChartData[0] : [];
  userPieChartData = Array.isArray(user.pieChartData) ? user?.pieChartData[0] : [];
}
...
export const getLineChartData = (role) => {
  return role === 'admin' ? adminLineChartData : userLineChartData;
};



export const lineChartData = getLineChartData(user?.role);
...
export const lineCustomSeries = [
  { dataSource: lineChartData?lineChartData[0]:[],
    xName: 'x',
    yName: 'y',
    name: 'Websites',
    width: '2',
  ...
  { dataSource: lineChartData?lineChartData[1]:[],
    xName: 'x',
    yName: 'y',
    name: 'APIs',
    width: '2',
  ...
  { dataSource: lineChartData?lineChartData[2]:[],
    xName: 'x',
    yName: 'y',
    name: 'Databases',
    width: '2',
...
const adminPieChartData = [
  { x: 'Website Deployment', y: 18, text: '18%' },
  { x: 'Service Maintainance', y: 8, text: '8%' },
  { x: 'Production', y: 15, text: '15%' },
  { x: 'License', y: 11, text: '11%' },
  { x: 'Server', y: 18, text: '18%' },
  { x: 'Taxes', y: 14, text: '14%' },
  { x: 'Insurance', y: 16, text: '16%' },
];

export const pieChartData = user?.role === 'admin' ? adminPieChartData : userPieChartData;
