...
export const ContextProvider = ({ children }) => {
  ...
  const setMode = (e) => {
    ...
    axios.patch(`${process.env.REACT_APP_BACKEND_BASE_URL}/themeMode/${user._id}`, { themeMode: e.target.value })
      .then((response) => {
  ...
  const setColor = (color) => {
    ...
    axios.patch(`${process.env.REACT_APP_BACKEND_BASE_URL}/themeColor/${user._id}`, { themeColor: color })
      .then((response) => {
