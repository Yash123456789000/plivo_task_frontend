  ...
  return (
    <div className="font-['Roboto'] min-h-screen bg-white text-gray-800 relative overflow-hidden">
      ...
      <main className="text-center px-6 py-20 max-w-4xl mx-auto">
        <h2
          className="text-4xl text-gray-500 opacity-100 transition-opacity duration-700"
          data-aos="fade-up"
        >
          Welcome to
        </h2>
        <h1
          className="text-6xl font-bold mt-2 text-gray-800 transition-transform duration-700 ease-out transform hover:scale-105"
          data-aos="fade-up"
        >
          Explore Real-time Monitoring
        </h1>
        <p
          className="mt-4 text-gray-600 transition-opacity duration-700"
          data-aos="fade-up"
        >
          Track the status of your services, manage incidents, and keep your
          users informed — all in one place.
        </p>
        ...
        {/* Stats */}
        <div
          className="flex flex-col md:flex-row justify-center gap-12 mt-24"
          data-aos="fade-up"
        >
          {[
            {
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <h1 className="text-5xl font-bold text-black mt-2">
              Built for Transparency & Uptime
            </h1>
            <p className="text-gray-600 mt-6">
              This platform helps teams monitor service health, manage real-time
              incidents, and keep users informed through a unified status page.
            </p>
            ...
            <div className="mt-10 space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="bg-orange-600 p-3 rounded-full">
                  <img
                    src="https://static.thenounproject.com/png/2015998-200.png"
                    alt="Service"
                    className="w-8 h-8"
                  />
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    Track APIs, websites, and databases — all in one place.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-orange-600 p-3 rounded-full">
                  <img
                    src="https://static.thenounproject.com/png/4303242-200.png"
                    alt="Real-time"
                    className="w-8 h-8"
                  />
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    Use WebSocket for instant visibility on status changes.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-orange-600 p-3 rounded-full">
                  <img
                    src="https://www.pngplay.com/wp-content/uploads/8/Team-Icon-Background-PNG-Image.png"
                    alt="Team"
                    className="w-8 h-8"
                  />
                </div>
                <div>
                  ...
                  <p className="text-gray-600">
                    Support multiple tenants with secure access controls.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Real-time monitoring and incident communication for your critical
              services. Keep users informed, build trust, and resolve faster.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-sm">
              <strong>Email:</strong> support@statusbit.app
            </p>
            <p className="text-sm">
              <strong>Twitter:</strong> @statusbit
            </p>
          </div>
        </div>
